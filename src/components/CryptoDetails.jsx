...
const CryptoDetails = () => {
  ...
  useEffect(() => {
    console.log("Refetching for timePeriod:", timePeriod, "coinId:", coinId);
    refetch();
  }, [timePeriod, refetch]);
  ...
  // Check if the data is still fetching
  if (isFetching) return <div>Loading...</div>;

  // Check if cryptoDetails is available
  if (!cryptoDetails) return <div>Crypto details not found.</div>;
...
<LineChart coinHistory={coinHistory} currentPrice={millify(cryptoDetails?.price)} coinName={cryptoDetails?.name} />
  ...
  {cryptoDetails.description ? HTMLReactParser(cryptoDetails.description) : <Text>No description available.</Text>}
</Row>
